    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="#"
                className="block py-2 px-3 text-white bg-primary rounded-sm md:bg-transparent md:text-gray-900 md:p-0 hover:text-primary"
                aria-current="page">
                Home
              </a>
            </li>
            <li>
              ...
              <div
                ...
                <div className="py-1">
                  <a
                    href="#"
                    className="block px-4 py-2 text-sm text-primary hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                    Sign out
                  </a>
                </div>
              </div>
